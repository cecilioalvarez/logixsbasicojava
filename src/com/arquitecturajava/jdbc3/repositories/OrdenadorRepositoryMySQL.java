...
public class OrdenadorRepositoryMySQL implements OrdenadorRepository {
    ...
    private final static String sqlBuscarBaratos="select * from Ordenador where precio<200 order by modelo";
    private final static String sqlBuscarUno= "select * from Ordenador where numero=? order by modelo";
